...
public class RollingAnalysisDriver
{
  ...
  public void generateResults(long startDate, long endDate)
    throws Exception
  {
    HashMap<Long, HashMap<String, Double>> resultMaps = new HashMap();
    

    long yearEnd = startDate / 10000L;
    yearEnd = yearEnd * 10000L + 1231L;
    

    this.startDate = startDate;
    
    while (yearEnd < endDate) {
      ...
      resultMaps.put(Long.valueOf(this.endDate), ppObj.getResultsMap());
    ...
    this.btGlobal.displayResults(resultMaps);
  }
    ...
    throws Exception
  {
    ...
    adjustMTMmap(consolMTMMap, Integer.valueOf(mtmFolders.length), "Fixed", activeScripCountMap);
